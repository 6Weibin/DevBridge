...
import { CheckCircle, FileText, Loader2, SlidersHorizontal, XCircle } from "lucide-react";
import { fetchModelList, getConfigDetail, saveConfig, testConfig } from "./aiApi";
import { AiConfigDetail, AiConfigRequest, AiConfigStatus, AiProvider } from "./aiTypes";
 ...
 * 渲染 AI 配置弹窗。
 */
export function AiConfigDialog({ open, initialStatus, onOpenChange, onConfigured }: AiConfigDialogProps) {
      ...
      <div className="w-full max-w-[760px] rounded-lg border border-border bg-background p-5 shadow-2xl">
        ...
        <div className="mt-5 flex justify-end gap-2">
          <button
            type="button"
            onClick={handleTest}
            disabled={loadingDetail || testing || saving}
