package com.devbridge.server.ai.mcp.security;
...
/**
 * ADB 输出安全处理器，统一执行截断和敏感信息脱敏。
 *
 * <p>by AI.Coding</p>
 */
@Component
public class AdbOutputSanitizer {
     ...
     * @param masker 脱敏工具
     */
    public AdbOutputSanitizer(SensitiveDataMasker masker) {
        this.masker = masker;
    }
    ...
    /**
     * 限制单行流式输出长度，避免 dumpsys 等命令出现极长行时冲击 Electron 渲染进程。
     *
     * @param line 原始行
     * @return 限制后的行
     */
